        ...
        <div className="body">
            ...
            <div className="bigcontainer">
                ...
                <div class="container reddit-mono-fonte">
                    ...
                    <label>Clube:</label><Form.Control className="input" type="text" name="name" id="nome" onChange={alterarClube}/>
                    <label>Vitórias:</label><Form.Control className="input" type="number" name="payment" id="salario" onChange={alterarWin} disabled={!clube}/>
                    <label>Empates:</label><Form.Control className="input" type="number" name="payment" id="salario" onChange={alterarDraw} disabled={!win}/>
